...
namespace Assignment_13._3
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UserContext>(options => options.UseSqlServer("Server = LAPTOP-VV46SPLS;Database=MSSAUsers;Trusted_Connection=True;MultipleActiveResultSets=True"));
        }
